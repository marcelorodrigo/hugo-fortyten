...
* feat(theme): Add GitHub nav link and bump Hugo to v0.161.0 by @marcelorodrigo in https://github.com/marcelorodrigo/hugo-fortyten/pull/28
* fix: Replace deprecated Hugo v0.158.0 language properties by @marcelorodrigo in https://github.com/marcelorodrigo/hugo-fortyten/pull/30

**Full Changelog**: https://github.com/marcelorodrigo/hugo-fortyten/compare/v3.0.0...v3.0.1
